# The Cornerstone Project — Document Index

This index provides a stable table of contents for The Cornerstone Project document suite.

**Recommended Reading Order:** Charter → Whitepaper → Public Standard → Supporting Specs → Playbook → Threat Model  
**Version:** v1.0 (Initial Publication)

---

## 1) Core Documents (Recommended Reading Order)
...
## 4) Diagrams (Planned / In Progress)

Diagrams will be published in: `docs/diagrams/`

Planned diagrams:
- **Architecture Overview** — Cornerstone OS as a governing layer between model and user
- **Module Flow** — internal governance modules and decision flow
- **Worldview Consent Flow** — worldview mode selection and “Do Not Offer Faith” gating

*(These will be added in v1.1.)*
...
- **v1.0** — Initial public release and defensive publication.
- Future versions will be tagged as GitHub releases and documented in the changelog.
...
1) A public ethical standard suite for Companion Intelligence  
2) A defensive publication (prior art)

Implementation is intentionally not included in this release.  
The goal is to establish ethical foundations, boundaries, and governance requirements that can be implemented across platforms and future robotics.
